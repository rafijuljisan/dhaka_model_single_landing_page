...
// YouTube video ID — update this
$youtube_id = '57Q9hgvXpHQ'; // ← Replace with your video ID

// Curriculum items
$curriculum = [
  ['icon'=>'walk',    'title'=>'রানওয়ে ওয়াক',        'desc'=>'পেশাদার ক্যাটওয়াক টেকনিক ও পোশচার ট্রেনিং'],
  ['icon'=>'camera',  'title'=>'ক্যামেরা পোজিং',       'desc'=>'ফটোশুট ও ভিডিও শ্যুটের জন্য পোজিং মাস্টারক্লাস'],
  ['icon'=>'face',    'title'=>'স্কিন কেয়ার',          'desc'=>'ত্বকের যত্ন, মেকআপ বেসিক ও ব্যক্তিগত গ্রুমিং'],
  ['icon'=>'body',    'title'=>'ফিটনেস ও ডায়েট',       'desc'=>'মডেলিংয়ের জন্য প্রয়োজনীয় শারীরিক সুস্থতা'],
  ['icon'=>'style',   'title'=>'স্টাইলিং ও ফ্যাশন',    'desc'=>'পোশাক নির্বাচন, কালার থিওরি ও ব্যক্তিত্ব বিকাশ'],
  ['icon'=>'network', 'title'=>'ইন্ডাস্ট্রি নেটওয়ার্ক', 'desc'=>'ব্র্যান্ড, ফটোগ্রাফার ও এজেন্সির সাথে সংযোগ'],
];

// Mentors (Reduced to 1 as requested)
$mentors = [
  ['name'=>'দিলরুবা দোয়েল', 'title'=>'প্রধান গ্রুমিং ও স্টাইলিং মেন্টর', 'exp'=>'১০+ বছরের অভিজ্ঞতা', 'img'=>'assets/mentor-1.jpg'],
];

// FAQ
$faqs = [
  ['q'=>'আগে কোনো অভিজ্ঞতা দরকার আছে কি?',
   'a'=>'না, একদমই না! এই প্রোগ্রামটি সম্পূর্ণ নতুনদের জন্যও ডিজাইন করা হয়েছে। আমরা একদম শুরু থেকে সব শেখাই।'],
  ['q'=>'গ্রুমিং সেশনে কী পরে আসতে হবে?',
   'a'=>'আরামদায়ক, ফিটিং পোশাক পরে আসুন। নিজের পছন্দের ২টি আউটফিট সঙ্গে আনতে পারেন স্টাইলিং সেশনের জন্য।'],
  ['q'=>'রেজিস্ট্রেশন ফি কি ফেরতযোগ্য?',
   'a'=>'সিট কনফার্ম হওয়ার ৪৮ ঘণ্টার মধ্যে বাতিল করলে সম্পূর্ণ ফি ফেরত পাবেন। এর পরে বাতিল করলে ৫০% ফেরত দেওয়া হবে।'],
  ['q'=>'প্রোগ্রামটি কতদিন চলবে?',
   'a'=>'মোট ৬ সপ্তাহের প্রোগ্রাম। প্রতি সপ্তাহান্তে (শুক্র ও শনি) ঢাকায় আমাদের স্টুডিওতে ক্লাস অনুষ্ঠিত হবে।'],
];
...
<meta name="description" content="ঢাকা মডেল এজেন্সি গ্রুমিং প্রোগ্রাম ২০২৬ — পেশাদার মডেলিং ক্যারিয়ারের সঠিক শুরু">
<meta property="og:title" content="ঢাকা মডেল এজেন্সি গ্রুমিং প্রোগ্রাম">
<meta property="og:description" content="আপনার মডেলিং ক্যারিয়ার শুরু হোক সঠিক গ্রুমিং দিয়ে। সীমিত আসন — এখনই রেজিস্ট্রেশন করুন।">
<title>গ্রুমিং প্রোগ্রাম — ঢাকা মডেল এজেন্সি</title>
...
<section class="hero" id="hero">
  <div class="hero-content">
    ...
    <p class="hero-sub">
      ২ মাসের নিবিড় প্রফেশনাল গ্রুমিং প্রোগ্রাম।
      রানওয়ে থেকে ক্যামেরা — সব কিছু শিখুন শিল্পের সেরা মেন্টরদের কাছ থেকে।
    </p>
    <?php if ($is_active): ?>
...
<div class="stats-bar reveal">
  <div class="stats-bar-inner">
    <div class="stat-item">
      ...
      <div class="stat-lbl">সপ্তাহের প্রোগ্রাম</div>
    </div>
    <div class="stat-item">
      <div class="stat-num">৫০০+</div>
      <div class="stat-lbl">সফল মডেল</div>
    </div>
    <div class="stat-item">
      <div class="stat-num">১</div>
      <div class="stat-lbl">বিশেষজ্ঞ মেন্টর</div>
    </div>
    <div class="stat-item">
      <div class="stat-num">৬</div>
...
<section class="video-section" id="video">
  <div class="container">
    ...
    <div class="video-wrap reveal">
      <div class="yt-facade" id="ytFacade" data-ytid="<?= htmlspecialchars($youtube_id) ?>">
              <img src="https://i.ytimg.com/vi/<?= htmlspecialchars($youtube_id) ?>/sddefault.jpg"
                  alt="DMA Grooming Program Video"
                  loading="lazy">
                  onerror="this.onerror=null; this.src='https://i.ytimg.com/vi/<?= htmlspecialchars($youtube_id) ?>/sddefault.jpg'">
    ...
    <p class="video-caption reveal">আমাদের প্রোগ্রামের পেছনের দৃশ্য এবং সফল মডেলদের অভিজ্ঞতা</p>
  </div>
</section>
...
<section class="section" id="mentors">
  <div class="container">
    <div class="reveal" style="text-align: center; display: flex; flex-direction: column; align-items: center;">
      ...
      <p class="section-subtitle">বছরের পর বছরের বাস্তব অভিজ্ঞতা থেকে শিখুন।</p>
    </div>
    ...
    <div class="form-layout">
      ...
      <div class="form-pitch reveal">
        ...
        <p style="color:var(--text-muted);font-size:1.05rem;margin-bottom:0; line-height: 1.6;">
          ...
          আপনার তথ্য পূরণ করুন — আমরা ৩ কার্যদিবসের মধ্যে যোগাযোগ করব।
        </p>

        <ul class="form-benefits">
          <li>পেশাদার মেন্টরের সরাসরি গাইডেন্স</li>
          <li>২ মাসের স্ট্রাকচার্ড প্রোগ্রাম</li>
          <li>সার্টিফিকেট অফ কমপ্লিশন</li>
          <li>ইন্ডাস্ট্রি নেটওয়ার্কে প্রবেশাধিকার</li>
          <li>পোর্টফোলিও ফটোশুটের সুযোগ</li>
        </ul>

        <div class="price-box">
          <div class="price-label">কোর্স ফি</div>
          <div class="price-amount">৳১২,০০০</div>
          <div class="price-note">ভর্তির পর পেমেন্ট নিশ্চিত করতে হবে</div>
        </div>
      </div>
      ...
      <div class="reveal">
        <div class="form-card">
          ...
          <form method="POST" action="/submit.php" enctype="multipart/form-data" id="regForm" novalidate>
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <input class="form-input" type="date" id="dob" name="dob"
                       ...
                       required>
                <div class="form-hint">বয়স ১৬–৩৫ বছরের মধ্যে হতে হবে</div>
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <select class="form-select" id="height_cm" name="height_cm" required>
                  ...
                  <?php
                  // Automatically generate exact heights from 4'5" to 6'8"
                  for ($feet = 4; $feet <= 6; $feet++) {
                      for ($inches = 0; $inches <= 11; $inches++) {
                          // Start at 4'5" and end at 6'8"
                          if ($feet == 4 && $inches < 5) continue; 
                          if ($feet == 6 && $inches > 8) continue;

                          // Calculate exact CM for the backend
            ...
            <div class="form-group">
              <label class="form-label" for="experience">পূর্ব অভিজ্ঞতা <span>*</span></label>
...
<footer class="footer">
  ...
  <div class="footer-contact">
    <?php if ($contact_phone): ?><a href="tel:<?= htmlspecialchars($contact_phone) ?>"><?= htmlspecialchars($contact_phone) ?></a>  ·  <?php endif; ?>
    <?php if ($contact_email): ?><a href="mailto:<?= htmlspecialchars($contact_email) ?>"><?= htmlspecialchars($contact_email) ?></a><?php endif; ?>
  </div>
  <div class="footer-copy">© <?= date('Y') ?> ঢাকা মডেল এজেন্সি। সর্বস্বত্ব সংরক্ষিত।</div>
</footer>
